...
#define TOPIC7   "/telecos/jaume/rebedor/bmp280t"    //Per publicar dades
#define TOPIC8   "/telecos/jaume/rebedor/bmp280p"    //Per publicar dades
...
void setup() {
  ...
  //BMP280
  Serial.println("[BMP ] BMP280 test");
  //if (!bmp280.init(0x77)) {
  if (!bmp280.init(0x76)) {
  ...
  taskScheduler.setInterval(11000L, publishBMP280);        //tasca 6
}
...
void publishBMP280()
{
  ...
  Serial.print("[BMPt] T: ");
  temperatureBMP = bmp280.getTemperature() * 100;
  Serial.println(temperatureBMP);
  Serial.print("[BMPp] P: ");
  pressureBMP = bmp280.getPressure()/100;
