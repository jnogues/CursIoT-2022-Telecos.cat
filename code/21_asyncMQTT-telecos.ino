...
#define TOPIC6   "/telecos/jaume/state"      //Per publicar dades
#define TOPIC10  "/telecos/jaume/commands"   //Per rebre comandaments
#define TOPIC11  "/telecos/jaume/pwm0"       //Per rebre comandaments
...
//boolean stateGPIO0=0;     //GPIO0 sortida pwm0
//boolean prevstateGPIO0=0;
//boolean stateGPIO2=0;     //GPIO2 es utilitzat com wifi stat led
...
void setup() {
  ...
  Serial.println("[boot] 21_asyncMQTT-telecos.ino");
...
void onWifiDisconnect(const WiFiEventStationModeDisconnected& event) {
  ...
  //wifiReconnectTimer.once(2, connectToWifi); //No cal
}
