...
//------------------ CONFIGURACIÓ ------------------------------------------------------------------
char auth[] = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"; //token (super-password) obtingut a l'app del mòbil
...
void setup() 
{
  ...
  Serial.println("_2022_01_06_ex4-telecos.ino");
