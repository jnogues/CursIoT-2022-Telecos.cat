...
//------------------ CONFIGURACIÓ ------------------------------------------------------------------
char auth[] = "xxxxxxxxxxxxxxxxxxxxxxxxxxxx"; //token (super-password) obtingut a l'app del mòbil
...
void setup() 
{
  ...
  Serial.println("_2022_01_04_ex10-telecos.ino");
