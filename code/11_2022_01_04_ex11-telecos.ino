...
//------------------ CONFIGURACIÓ ------------------------------------------------------------------
char auth[] = "Ra6VYnUCRIEcq4DyrDoOINfpezHZnxSt"; //token (super-password) obtingut a l'app del mòbil
char ssid[] = "viscalaterra"; //xarxa wifi
char pass[] = "pitufito*"; //password wifi
...
void setup() 
{
  ...
  Serial.println("_2022_01_04_ex11-telecos.ino");
