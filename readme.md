...
4. IP del broker mosquitto del Rambla Prim, 5.196.88.155, port 1883.
5. Per instl·lar els clients **mosquitto_sub i mosquitto_pub** en LINUX, `sudo apt install mosquitto-clients`.
6. Per subscriure't a un topic: `mosquitto_sub -v -h 5.196.88.155 -t /kkp2/#`.
7. Per publicar en un topic: `mosquitto_pub -h 5.196.88.155 -t /kkp2/temperatura -m 23.5`.
8. Broker públic: `test.mosquitto.org`.
9. 
10. 
